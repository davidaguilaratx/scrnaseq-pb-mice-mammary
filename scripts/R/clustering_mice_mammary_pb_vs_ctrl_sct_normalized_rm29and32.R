...
saveRDS(split_seurat, 'data/split_seurat_rm29and32.rds')
...
saveRDS(seurat_merged_sct, 'data/seurat_merged_sct_rm29and32.rds')
...
saveRDS(sct_results, 'figures/clustering_rm29and32/sct_results_rm29and32.rds')
...
lapply(seq_along(split_seurat), function(x,n,i) {
  ...
  LabelPoints(plot=p, points = top25_sct, repel = TRUE)+
    ...
    theme_classic2()
  ggsave(paste0('figures/clustering_rm29and32/top25_variable_genes_seurat_phase_',n[[i]],'.png'), dpi=320, width=20, height= 10)
...
ggsave('figures/clustering_rm29and32/sct/PCA_loadings_sct.png', dpi=320, width=20, height= 15)


png(filename = 'figures/clustering_rm29and32/sct/high_score_genes_per_PC1-6_heatmap_sct.png', units='in', width=20, height=10, res=320)
...
png(filename = 'figures/clustering_rm29and32/sct/high_score_genes_per_PC7-12_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 7:12,
           cells=500,
...
png(filename = 'figures/clustering_rm29and32/sct/high_score_genes_per_PC13-18_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 13:18,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32/sct/high_score_genes_per_PC19-24_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 19:24,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32/sct/high_score_genes_per_PC25-30_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 25:30,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32/sct/high_score_genes_per_PC31-36_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 31:36,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32/sct/high_score_genes_per_PC37-42_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 37:42,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32/sct/high_score_genes_per_PC43-50_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 43:50,
           ncol=4,
...
ElbowPlot(object = seurat_merged_sct, 
  ...
  theme(plot.title = element_text(hjust=0.5, face="bold"),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32/sct/elbow_plot_sct.png', dpi=320, width=20, height= 10)
...
ggplot(plot_df, aes(cumu, pct, label = rank, color = rank > pcs)) + 
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32/sct/quantitative_elbow_plot_sct.png', dpi=320, width=20, height= 10)
...
plot_umaps(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.1', directory='figures/clustering_rm29and32/sct/')
...
umap_clustering_qc(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.1', directory='figures/clustering_rm29and32/sct/')
