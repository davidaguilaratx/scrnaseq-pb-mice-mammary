...
filtered_seurat = readRDS('data/filtered_seurat_rm29and32_5xMADfiltering.rds')
...
LabelPoints(plot=p, points = top25, repel = TRUE)+
  ...
  theme_classic2()
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/top25_variable_genes_seurat_phase.png', dpi=320, width=20, height= 10)


# Scale the counts
seurat_pca = ScaleData(seurat_phase)
...
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/PCA_by_cellcycle_phase_genes.png', dpi=320, width=20, height= 10)
...
seurat_pca = ScaleData(seurat_pca, vars.to.regress = c("cc.difference","percent.mt"), features = rownames(seurat_pca))
saveRDS(seurat_pca, 'data/seurat_phase_rm29and32_5xMAD_regressout_cc.diffandmt.rds')
...
DimPlot(seurat_pca,
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/PCA_by_cellcycle_phase_genes_ccdiff_regressed_out.png', dpi=320, width=20, height= 10)
# # still some variability between phases

## What about mitochondrial expression?
DimPlot(seurat_pca,
        reduction = "pca",
        group.by= "mito.level",
        split.by='mito.level')+
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/PCA_by_cellcycle_phase_genes_percent.mt_regressed_out.png', dpi=320, width=20, height= 10)
# # still some variability between phases
...
DimPlot(seurat_pca,
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/PCA_by_cellcycle_phase_allgenes_.png', dpi=320, width=20, height= 10)
...
DimPlot(seurat_pca,
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt//PCA_by_mitochondrial_expression_quartile.png', dpi=320, width=20, height= 10)
...
DimPlot(seurat_pca,
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/PCA_by_condition.png', dpi=320, width=20, height= 10)
...
split_seurat = lapply(split_seurat, function(x) {
  x = SCTransform(x, assay='RNA', vst.flavor ="v2", variable.features.n=3000,# default params
                  vars.to.regress=c('cc.difference','percent.mt'),return.only.var.genes=FALSE) 
 
})
saveRDS(split_seurat, 'data/split_seurat_rm29and32_5xMAD_regressout_cc.diffandmt.rds')
...
saveRDS(seurat_merged_sct, 'data/seurat_merged_sct_rm29and32_5xMAD_regressout_cc.diffandmt.rds')
...
saveRDS(sct_results, 'figures/clustering_rm29and32/sct_results_rm29and32_5xMADfiltering_regressout_cc.diffandmt.rds')
...
lapply(seq_along(split_seurat), function(x,n,i) {
  ...
  LabelPoints(plot=p, points = top25_sct, repel = TRUE)+
    ...
    theme_classic2()
  ggsave(paste0('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/top25_variable_genes_seurat_phase_',n[[i]],'.png'), dpi=320, width=20, height= 10)
...
saveRDS(seurat_merged_sct, 'data/seurat_merged_sct_rm29and32_5xMADfiltering_regressout_cc.diffandmt.rds')
...
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/PCA_loadings_sct.png', dpi=320, width=20, height= 15)


png(filename = 'figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/high_score_genes_per_PC1-6_heatmap_sct.png', units='in', width=20, height=10, res=320)
...
png(filename = 'figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/high_score_genes_per_PC7-12_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 7:12,
           cells=500,
...
png(filename = 'figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/high_score_genes_per_PC13-18_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 13:18,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/high_score_genes_per_PC19-24_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 19:24,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/high_score_genes_per_PC25-30_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 25:30,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/high_score_genes_per_PC31-36_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 31:36,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/high_score_genes_per_PC37-42_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 37:42,
           ncol=3,
...
png(filename = 'figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/high_score_genes_per_PC43-50_heatmap_sct.png', units='in', width=20, height=10, res=320)
DimHeatmap(object = seurat_merged_sct, 
           reduction = "pca", 
           dims = 43:50,
           ncol=4,
...
ElbowPlot(object = seurat_merged_sct, 
  ...
  theme(plot.title = element_text(hjust=0.5, face="bold"),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/elbow_plot_sct.png', dpi=320, width=20, height= 10)
...
ggplot(plot_df, aes(cumu, pct, label = rank, color = rank > pcs)) + 
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
        ...
        axis.text = element_text(size=12),
        title = element_text(size=18))
ggsave('figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/quantitative_elbow_plot_sct.png', dpi=320, width=20, height= 10)
...
## clusters after running with dims=1:50 filtered by 5xMAD, removed low quality samples 29 and 31, and regressed out cc.differecne and percent.mt
# Resolution 0.1: 13 clusters
# Resolution 0.2: 16 clusters
# Resolution 0.4: 21 clusters
# Resolution 0.6: 24 clusters
...
saveRDS(seurat_umap_sct, 'data/seurat_umap_sct_rm29and32_5xMADfiltering_regressout_cc.diffandmt.rds')
...
plot_umaps(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.1', directory='figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/')
...
umap_clustering_qc(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.1', directory='figures/clustering_rm29and32_5xMADfiltering_regress_ccdiffandmt/sct/')
...
pcs_umap_overlay(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.1', directory='figures/clustering_rm29and32/sct/')
...
# takes a while to run
plot_gene_markers(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.1', directory='figures/clustering_rm29and32/sct/')
...
plot_umaps(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.2', directory='figures/clustering_rm29and32/sct/')

# clustering QC at SCT_snn_res.0.2 resolution ----
umap_clustering_qc(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.2', directory='figures/clustering_rm29and32/sct/')

## plot PCs on umap for resolution SCT_snn_res.0.2 ----
pcs_umap_overlay(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.2', directory='figures/clustering_rm29and32/sct/')

## overlay umap and create dotplot with gene markers for resolution SCT_snn_res.0.2. ----
# takes a while to run
plot_gene_markers(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.2', directory='figures/clustering_rm29and32/sct/')
...
plot_umaps(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.4', directory='figures/clustering_rm29and32/sct/')

# clustering QC at SCT_snn_res.0.4 resolution ----
umap_clustering_qc(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.4', directory='figures/clustering_rm29and32/sct/')

## plot PCs on umap for resolution SCT_snn_res.0.4 ----
pcs_umap_overlay(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.4', directory='figures/clustering_rm29and32/sct/')

## overlay umap and create dotplot with gene markers for resolution SCT_snn_res.0.4. ----
# takes a while to run
plot_gene_markers(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.4', directory='figures/clustering_rm29and32/sct/')
...
plot_umaps(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.8', directory='figures/clustering_rm29and32/sct/')

# clustering QC at SCT_snn_res.0.8 resolution ----
umap_clustering_qc(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.8', directory='figures/clustering_rm29and32/sct/')

## plot PCs on umap for resolution SCT_snn_res.0.8 ----
pcs_umap_overlay(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.8', directory='figures/clustering_rm29and32/sct/')

## overlay umap and create dotplot with gene markers for resolution SCT_snn_res.0.8. ----
# takes a while to run
plot_gene_markers(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.0.8', directory='figures/clustering_rm29and32/sct/')
...
plot_umaps(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.1.2', directory='figures/clustering_rm29and32/sct/')

# clustering QC at SCT_snn_res.1.2 resolution ----
umap_clustering_qc(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.1.2', directory='figures/clustering_rm29and32/sct/')

## plot PCs on umap for resolution SCT_snn_res.1.2 ----
pcs_umap_overlay(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.1.2', directory='figures/clustering_rm29and32/sct/')

## overlay umap and create dotplot with gene markers for resolution SCT_snn_res.1.2 ----
# takes a while to run
plot_gene_markers(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.1.2', directory='figures/clustering_rm29and32/sct/')
...
plot_umaps(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.1.4', directory='figures/clustering_rm29and32/sct/')

# clustering QC at SCT_snn_res.1.4 resolution ----
umap_clustering_qc(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.1.4', directory='figures/clustering_rm29and32/sct/')

## plot PCs on umap for resolution SCT_snn_res.1.4 ----
pcs_umap_overlay(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.1.4', directory='figures/clustering_rm29and32/sct/')

## overlay umap and create dotplot with gene markers for resolution SCT_snn_res.1.4 ----
# takes a while to run
plot_gene_markers(seurat_umap=seurat_umap_sct, resolution='SCT_snn_res.1.4', directory='figures/clustering_rm29and32/sct/')
...
sweep.res.list = paramSweep(seurat_umap_sct, PCs = 1:50, sct = TRUE)
sweep.stats = summarizeSweep(sweep.res.list, GT = FALSE)
bcmvn = find.pK(sweep.stats)

## Homotypic Doublet Proportion Estimate 
homotypic.prop <- modelHomotypic(annotations) ## ex: annotations <- seu_kidney@meta.data$ClusteringResults
nExp_poi <- round(0.0008*nrow(seurat_umap_sct@meta.data))  ## Assuming 7.5% doublet formation rate - tailor for your dataset
nExp_poi.adj <- round(nExp_poi*(1-homotypic.prop))

## Run DoubletFinder with varying classification stringencies
seurat_umap_sct = doubletFinder(seurat_umap_sct, PCs = 1:50, pN = 0.25, pK = 0.09, nExp = nExp_poi, reuse.pANN = FALSE, sct = TRUE)
seurat_umap_sct = doubletFinder(seurat_umap_sct, PCs = 1:50, pN = 0.25, pK = 0.09, nExp = nExp_poi.adj, reuse.pANN = "pANN_0.25_0.09_913", sct = TRUE)
